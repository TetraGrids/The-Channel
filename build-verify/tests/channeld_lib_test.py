...
try:
    ...
    if localTest and not dontLaunch:
        ...
        if cluster.launch(totalNodes=total_nodes, pnodes=pnodes, topo=topo, prodCount=prodCount, activateIF=activateIF, onlyBios=onlyBios, dontBootstrap=dontBootstrap, extraChanneldArgs=extraChanneldArgs, specificChanneldInstances=specificChanneldInstances) is False:
            cmdError("launcher")
