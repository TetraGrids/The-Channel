...
BOOST_AUTO_TEST_CASE(name_suffix_tests)
{
   ...
   BOOST_CHECK_EQUAL( name{"ra"_n}.suffix(), name{"ra"_n} );
   BOOST_CHECK_EQUAL( name{"ra.any"_n}.suffix(), name{"any"_n} );
...
BOOST_AUTO_TEST_CASE(name_suffix_additional_tests) {
   ...
   BOOST_CHECK_EQUAL( name{"ra.accounj"}.suffix(), name{"accounj"} );
...
BOOST_AUTO_TEST_CASE(name_prefix_tests)
{
   ...
   BOOST_CHECK_EQUAL("ra.any"_n.prefix(), "ra"_n);
   BOOST_CHECK_EQUAL("ra"_n.prefix(), "ra"_n);
   BOOST_CHECK_EQUAL("ra"_n.prefix(), config::system_account_name);
   BOOST_CHECK_EQUAL("eosio."_n.prefix(), "ra"_n);
   BOOST_CHECK_EQUAL("ra.evm"_n.prefix(), "ra"_n);
   BOOST_CHECK_EQUAL(".eosio"_n.prefix(), ""_n);
   BOOST_CHECK_NE("eosi"_n.prefix(), "ra"_n);
   BOOST_CHECK_NE("eosioeosio"_n.prefix(), "ra"_n);
   BOOST_CHECK_NE("eosioe"_n.prefix(), "ra"_n);
}
