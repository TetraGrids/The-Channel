...
BOOST_AUTO_TEST_CASE(fix_linkauth_restriction) { try {
   ...
   validate_disallow("ra", "linkauth");
   validate_disallow("ra", "unlinkauth");
   validate_disallow("ra", "deleteauth");
   validate_disallow("ra", "updateauth");
   validate_disallow("ra", "canceldelay");
...
BOOST_AUTO_TEST_CASE(producer_schedule_change_extension_test) { try {
   ...
   { // ensure producer_schedule_change_extension is rejected
      ...
      bad_block->producer_signature = remote.get_private_key("ra"_n, "active").sign(sig_digest);
...
BOOST_AUTO_TEST_CASE(wtmsig_block_signing_inflight_legacy_test) { try {
   ...
   c.activate_protocol_features( {*d} );
   vector<legacy::producer_key> sched = {{"ra"_n, c.get_public_key("ra"_n, "bsk")}};
   ...
   c.block_signing_private_keys.emplace(get_public_key("ra"_n, "bsk"), get_private_key("ra"_n, "bsk"));
   c.produce_block();
