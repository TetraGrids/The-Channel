...
void compatible_versions_test()
{
   ...
   int ordinal = 0;
   for(std::string version : {"v2", "v3", "v4", "v5", "v6", "v8", "v9"}) // v7 version not supported in The Channel 1.0.1 and above
   {
   ...
   // 3. copy the newly generated files (see `ls -lrth ./unittests/snapshots/snap_*` to `channel/unittests/snapshots`
