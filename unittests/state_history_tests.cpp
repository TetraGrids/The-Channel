...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_deltas_permission_link, T, table_deltas_testers) {
   ...
   chain.link_authority("newacc"_n, "ra"_n, "spending"_n, "reqauth"_n);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_deltas_resources_history, T, table_deltas_testers) {
   ...
   chain.create_accounts({ "ra.token"_n, "ra.ram"_n, "ra.ramfee"_n, "ra.stake"_n, "ra.rex"_n});
   ...
   chain.push_action("ra.token"_n, "issue"_n, "ra.token"_n, fc::mutable_variant_object()
      ("to",       "ra")
