...
#include <ra.system/exchange_state.hpp>
...
namespace rasystem {
  ...
  /**
   * The `ra.system` smart contract is provided by `block.one` as a sample system contract, and it defines the structures and actions needed for blockchain's core functionality.
   *
   * Just like in the `ra.bios` sample contract implementation, there are a few actions which are not implemented at the contract level (`newaccount`, `updateauth`, `deleteauth`, `linkauth`, `unlinkauth`, `canceldelay`, `onerror`, `setabi`, `setcode`), they are just declared in the contract so they will show in the contract's ABI and users will be able to push those actions to the chain via the account holding the `ra.system` contract, but the implementation is at the EOSIO core level. They are referred to as EOSIO native actions.
   *
   ...
   */
   ...
   struct [[eosio::table, eosio::contract("ra.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[eosio::table, eosio::contract("ra.system")]] bid_refund {
      name         bidder;
      asset        amount;
   ...
   struct [[eosio::table("global"), eosio::contract("ra.system")]] eosio_global_state : eosio::blockchain_parameters {
   ...
   struct [[eosio::table("global2"), eosio::contract("ra.system")]] eosio_global_state2 {
      eosio_global_state2(){}
   ...
   struct [[eosio::table("global3"), eosio::contract("ra.system")]] eosio_global_state3 {
      eosio_global_state3() { }
   ...
   struct [[eosio::table("global4"), eosio::contract("ra.system")]] eosio_global_state4 {
      eosio_global_state4() { }
   ...
   struct [[eosio::table, eosio::contract("ra.system")]] producer_info {
      name                                                     owner;
      ...
      eosio::block_signing_authority get_producer_authority()const {
         if( producer_authority.has_value() ) {
            ...
            // zero_threshold could be true despite the validation done in regproducer2 because the v1.9.0 ra.system
   ...
   struct [[eosio::table, eosio::contract("ra.system")]] producer_info2 {
      name            owner;
   ...
   struct [[eosio::table("finkeys"), eosio::contract("ra.system")]] finalizer_key_info {
   ...
   struct [[eosio::table("finalizers"), eosio::contract("ra.system")]] finalizer_info {
   ...
   struct [[eosio::table("lastpropfins"), eosio::contract("ra.system")]] last_prop_finalizers_info {
   ...
   struct [[eosio::table("finkeyidgen"), eosio::contract("ra.system")]] fin_key_id_generator_info {
   ...
   struct [[eosio::table, eosio::contract("ra.system")]] voter_info {
   ...
   struct [[eosio::table, eosio::contract("ra.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
   ...
   struct [[eosio::table, eosio::contract("ra.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("ra.system")]] refund_request {
      name            owner;
   ...
   struct [[eosio::table,eosio::contract("ra.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   struct [[eosio::table,eosio::contract("ra.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   struct [[eosio::table,eosio::contract("ra.system")]] rex_return_buckets {
      uint8_t                                version = 0;
   ...
   struct [[eosio::table,eosio::contract("ra.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   struct [[eosio::table,eosio::contract("ra.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   struct [[eosio::table,eosio::contract("ra.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   struct [[eosio::table,eosio::contract("ra.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
   ...
   struct [[eosio::table("rexmaturity"),eosio::contract("ra.system")]] rex_maturity {
   ...
   struct [[eosio::table("powup.state"),eosio::contract("ra.system")]] powerup_state {
   ...
   struct [[eosio::table("powup.order"),eosio::contract("ra.system")]] powerup_order {
      uint8_t              version = 0;
      uint64_t             id;
      name                 owner;
      int64_t              net_weight;
   ...
   class [[eosio::contract("ra.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name token_account{"ra.token"_n};
         static constexpr eosio::name ram_account{"ra.ram"_n};
         static constexpr eosio::name ramfee_account{"ra.ramfee"_n};
         static constexpr eosio::name stake_account{"ra.stake"_n};
         static constexpr eosio::name bpay_account{"ra.bpay"_n};
         static constexpr eosio::name vpay_account{"ra.vpay"_n};
         static constexpr eosio::name names_account{"ra.names"_n};
         ...
         static symbol get_core_symbol( name system_account = "ra"_n ) {
         ...
         static bool rex_system_initialized( name system_account = "ra"_n ) {
            rasystem::rex_pool_table _rexpool( system_account, system_account.value );
            return _rexpool.begin() != _rexpool.end();
         }

         // Returns true/false if the rex system is available
         static bool rex_available( name system_account = "ra"_n ) {
            rasystem::rex_pool_table _rexpool( system_account, system_account.value );
          ...
          *     The remaining inflation will be sent to the `ra.saving` account.
      ...
      private:
         ...
         static time_point_sec get_rex_maturity(const name& system_account_name = "ra"_n );
