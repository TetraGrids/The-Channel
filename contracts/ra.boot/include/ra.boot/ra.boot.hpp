...
namespace raboot {
   ...
   /**
    * @defgroup raboot ra.boot
    * @ingroup eosiocontracts
    *
    * ra.boot is a extremely minimalistic system contract that only supports the native actions and an
    * activate action that allows activating desired protocol features prior to deploying a system contract
    * with more features such as ra.bios or ra.system.
    *
    * @{
    */
   class [[eosio::contract("ra.boot")]] boot : public eosio::contract {
      public:
   ...
   /** @}*/ // end of @defgroup raboot ra.boot
} /// namespace raboot
