...
int main(int argc, char** argv)
{
   try {
      ...
      http_plugin::set_defaults({
         .default_unix_socket_path = keyd::config::key_store_executable_name + ".sock",
         .default_http_port = 0,
         .server_header = keyd::config::key_store_executable_name + "/" + app->version_string(),
      ...
      http.add_handler({"/v1/" + keyd::config::key_store_executable_name + "/stop",
                       api_category::node,
