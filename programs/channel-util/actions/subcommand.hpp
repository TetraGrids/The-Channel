...
class channel_util_exception_handler {
public:
   channel_util_exception_handler() {}
   ~channel_util_exception_handler() {}
   void print_exception() noexcept;
};

template<class subcommand_options, class exception_handler = channel_util_exception_handler>
class sub_command {
protected:
