   ...
   class private_key
   {
      public:
         using storage_type = std::variant<ecc::private_key_shim, r1::private_key_shim,
                                           em::private_key_shim, ed::private_key_shim>;
         ...
         static_assert(std::size(config::private_key_prefix) == static_cast<size_t>(key_type::unknown), "Missing private_key prefix");

         constexpr static const char* key_prefix(key_type t) { return config::private_key_prefix[static_cast<size_t>(t)]; };
         ...
         // The Channel native string form always carries the PVT_<TYPE>_ prefix.
...
FC_REFLECT_ENUM(fc::crypto::private_key::key_type, (k1)(r1)(em)(ed)(unknown))
