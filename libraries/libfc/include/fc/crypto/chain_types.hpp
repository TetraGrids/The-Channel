...
enum chain_key_type_t : uint8_t {
   ...
   chain_key_type_channel = 1,
   chain_key_type_channel_bls = 2,
...
constexpr std::size_t chain_address_size_channel     = key_size_sec256k1;

constexpr auto chain_public_key_types = std::tuple{
   std::pair{chain_kind_unknown,  std::pair{chain_key_type_unknown, std::size_t{0}}    },
   std::pair{chain_kind_channel,     std::pair{chain_key_type_channel, key_size_sec256k1}    },
...
constexpr auto chain_address_sizes = std::tuple{
   ...
   std::pair{chain_kind_channel,     std::pair{chain_key_type_channel, chain_key_type_channel}        },
...
constexpr auto chain_key_types = std::tuple{
   ...
   std::pair{chain_kind_channel,     std::tuple{chain_key_type_channel, chain_key_type_channel_bls}},
...
constexpr auto chain_key_type_to_key_types = std::tuple{
   ...
   std::pair{chain_key_type_channel,     std::tuple{key_type_k1, key_type_r1,key_type_em,key_type_ed}},
   std::pair{chain_key_type_channel_bls, std::tuple{key_type_bls}},
...
constexpr auto key_type_to_chain_key_types = std::tuple{
   ...
   std::pair{key_type_k1,      std::tuple{chain_key_type_channel}},
   std::pair{key_type_r1,      std::tuple{chain_key_type_channel}},
   ...
   std::pair{key_type_bls,     std::tuple{chain_key_type_channel_bls}},
};
