...
class allocator {
public:
   using pointer = typename backing_allocator::pointer;
...
public:
   using char_pointer = typename backing_allocator::pointer;
   using pointer      = typename char_pointer::template rebind<T>;
   using value_type   = T;
