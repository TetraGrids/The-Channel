...
namespace eosio { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( plugin_exception, chain_exception,
      ...
      // transient remote-signing failure (e.g. KMS throttle/timeout): callers may retry; distinct from
      // plugin_config_exception so startup probes can defer rather than abort the boot
      FC_DECLARE_DERIVED_EXCEPTION( signing_transient_exception,                  plugin_exception,
                                    3110008, "Transient signing error" )
