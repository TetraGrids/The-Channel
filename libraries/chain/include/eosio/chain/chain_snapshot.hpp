...
struct chain_snapshot_header {
    ...
    *   7: Updated for The Channel v1.0.0 release:
    ...
    *   8: Updated for The Channel v1.0.1 release:
    ...
    *         - The Channel v1.0.1 is incompatible with v7 format, but can read previous formats
    *   9: Updated for The Channel v2.0.0 release:
