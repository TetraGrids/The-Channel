...
//       in the persistent file) at The Channel startup.
//
//  my_finalizers_t:
//  ---------------
...
namespace eosio::chain {
   ...
   public:
      ///
      /// Version 0: The Channel 1.0.0 RC2 - File has fixed packed sizes with inactive safety info written to the end
      ///                               of the file. Consists of [finalizer public_key, FSI]..
      /// Version 1: The Channel 1.0.0 RC3 - File has inactive FSIs written at the beginning of the file. Uses crc32
   ...
   private:
      ...
      fsi_t                             default_fsi = fsi_t::unset_fsi(); // default provided at channel startup
