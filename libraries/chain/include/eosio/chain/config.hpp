...
const static name system_account_name    { "ra"_n };
const static name null_account_name      { "ra.null"_n };
const static name producers_account_name { "ra.prods"_n };
...
const static name eosio_auth_scope       { "ra.auth"_n };
const static name eosio_all_scope        { "ra.all"_n };

const static name active_name     { "active"_n };
const static name owner_name      { "owner"_n };
const static name eosio_any_name  { "ra.any"_n };
const static name eosio_code_name { "ra.code"_n };
