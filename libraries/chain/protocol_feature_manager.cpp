...
*/
         ...
         (  builtin_protocol_feature_t::em_ed_keys, builtin_protocol_feature_spec{
            "EM_ED_KEYS",
            fc::variant("dfc2e8e511691cb1e4c3e0792c48e2e882f74117e08b68b48f987903416bdd86").as<digest_type>(),
            // SHA256 hash of the raw message below within the comment delimiters (exclude newline after /*) (do not modify message below).
/*
Builtin protocol feature: EM_ED_KEYS

Enables usage of Ethereum-style secp256k1/keccak (EM) and Ed25519 (ED) keys and signatures for transactions and account authorities.
*/
            {}
         } )
