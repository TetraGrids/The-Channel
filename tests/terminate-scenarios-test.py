...
#
# Tests terminate scenarios for channeld.  Uses "-c" flag to indicate "replay" (--replay-blockchain), "resync"
...
try:
    ...
    Print("channeld instances 0 killed.")
    ...
    Print("channeld instance relaunched.")
