...
class Utils:
    ...
    EosClientPath=str(testBinPath / "chan")
    MiscEosClientArgs="--no-auto-keyd"

    SpringClientPath=str(testBinPath / "channel-util")

    EosWalletName="keyd"
    EosWalletPath=str(testBinPath / EosWalletName)

    EosServerName="channeld"
