...
try:
    ...
    specificExtraChanneldArgs[shipNodeNum]="--plugin eosio::state_history_plugin --sync-fetch-span 200 --plugin eosio::net_api_plugin "

    if args.unix_socket:
        specificExtraChanneldArgs[shipNodeNum] += "--state-history-unix-socket-path ship.sock"
    ...
    Print("Shutdown state_history_plugin channeld")
