...
###############################################################
# channeld_extra_packed_data_test
#
# Tests channeld rejects trx with extra data packed at the end.
#
###############################################################
...
try:
    ...
    if localTest and not dontLaunch:
        ...
        if pnodes > 1:
            specificExtraChanneldArgs[pnodes - 1] = ""
        if pnodes > 3:
            specificExtraChanneldArgs[pnodes - 2] = ""
    ...
    for i in range(trxNumber):
        ...
        packedTrx = node.processChanCmd(cmd, cmdDesc, silentErrors=False, exitOnError=True, exitMsg=exitMsg)
