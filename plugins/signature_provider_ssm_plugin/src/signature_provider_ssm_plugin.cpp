#include <eosio/signature_provider_ssm_plugin/signature_provider_ssm_plugin.hpp>
...
signature_provider_ssm_plugin::signature_provider_ssm_plugin() {
   ...
   sigprov::register_scheme_handler(ssm_spec_scheme, &eosio::sigprov::ssm::create_ssm_provider, name());
}
