...
public:
   // signature_provider_plugin: BLS finalizer-key spec parsing (finalizer-provider option);
   // signature_provider_manager_plugin: transaction/block signing key registry (signature-provider option)
   APPBASE_PLUGIN_REQUIRES((chain_plugin)(signature_provider_plugin)(signature_provider_manager_plugin))
