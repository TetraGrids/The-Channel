...
class cluster_generator:
    ...
    def parseArgs(self, args):
        ...
        parser.add_argument('--config-dir', type=Path, help='directory containing configuration files such as config.ini', default=Path('etc') / 'ra')
    ...
    def construct_command_line(self, instance: nodeDefinition):
        ...
        if instance.index in self.args.specific_nums:
            ...
            # Allow specific channeld args to override existing args up to this point.
