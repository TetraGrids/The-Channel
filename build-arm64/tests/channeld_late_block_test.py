...
try:
    ...
    if cluster.launch(pnodes=pnodes, totalNodes=total_nodes, extraChanneldArgs=extraChanneldArgs,
                      topo="./tests/channeld_late_block_test_shape.json", delay=delay, loadSystemContract=False,
