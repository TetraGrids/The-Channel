...
###############################################################
# channeld_short_fork_take_over_test
#
# Similar scenario to channeld_forked_chain_test, except that there are only 3 producers and, after the "bridge" node is
...
try:
    ...
    specificExtraChanneldArgs[totalProducerNodes]="--plugin eosio::test_control_api_plugin"
    ...
    if cluster.launch(prodCount=2, topo="bridge", pnodes=totalProducerNodes,
                      ...
                      specificExtraChanneldArgs=specificExtraChanneldArgs, extraChanneldArgs=extraChanneldArgs, onlySetProds=True) is False:
