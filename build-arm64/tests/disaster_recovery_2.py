...
try:
    ...
    specificExtraChanneldArgs[0]="--plugin eosio::net_api_plugin --plugin eosio::producer_api_plugin "

    if cluster.launch(pnodes=pnodes, totalNodes=total_nodes, totalProducers=pnodes, specificExtraChanneldArgs=specificExtraChanneldArgs,
