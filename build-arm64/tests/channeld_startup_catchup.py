...
try:
    ...
    specificExtraChanneldArgs[pnodes+1] = f' --sync-fetch-span 1 '
    specificExtraChanneldArgs[pnodes+2] = f' --sync-fetch-span 5 '
    specificExtraChanneldArgs[pnodes+3] = f' --sync-fetch-span 21 '
    specificExtraChanneldArgs[pnodes+4] = f' --sync-fetch-span 89 '
    specificExtraChanneldArgs[pnodes+5] = f' --sync-fetch-span 177 '
    specificExtraChanneldArgs[pnodes+6] = f' --sync-fetch-span 1597 '
    specificExtraChanneldArgs[pnodes+7] = f' --sync-fetch-span 2500 '
    specificExtraChanneldArgs[pnodes+8] = f' --sync-fetch-span 6765 '
    specificExtraChanneldArgs[pnodes+9] = f' --sync-fetch-span 28657 '
    specificExtraChanneldArgs[pnodes+10] = f' ' # default
    specificExtraChanneldArgs[pnodes+11] = f' --sync-fetch-span 1 --read-mode irreversible '
    specificExtraChanneldArgs[pnodes+12] = f' --sync-fetch-span 5 --read-mode irreversible '
    specificExtraChanneldArgs[pnodes+13] = f' --sync-fetch-span 89 --read-mode irreversible '
    specificExtraChanneldArgs[pnodes+14] = f' --sync-fetch-span 150 --read-mode irreversible '
    specificExtraChanneldArgs[pnodes+15] = f' --sync-fetch-span 2500 --read-mode irreversible '
    if cluster.launch(prodCount=prodCount, specificExtraChanneldArgs=specificExtraChanneldArgs, activateIF=activateIF, onlyBios=False,
    ...
    for catchup_num in range(0, catchupCount):
        ...
        irreversible = False
        if catchupNode.nodeId in specificExtraChanneldArgs:
            m = re.search(r"sync-fetch-span (\d+)", specificExtraChanneldArgs[catchupNode.nodeId])
            if m is not None:
                sync_fetch_span = int(m.group(1))
            irreversible = re.search(r"irreversible", specificExtraChanneldArgs[catchupNode.nodeId]) is not None
