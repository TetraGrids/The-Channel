...
See [Net API Reference Documentation](https://docs.eosnetwork.com/channel-plugins/latest/net.api/).
...
```sh
# command-line
channeld ... --plugin eosio::net_api_plugin
```
...
```sh
# command-line
channeld ... --plugin eosio::net_plugin [options]  \
