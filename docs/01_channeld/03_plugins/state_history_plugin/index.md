...
```sh
# command-line
channeld ... --plugin eosio::state_history_plugin [operations] [options]
```

## Operations

These can only be specified from the `channeld` command-line:
...
Config Options for eosio::state_history_plugin:
  ...
  --state-history-archive-dir arg       the location of the state history
                                        ...
                                        they won't be accessed by channeld
                                        anymore.
