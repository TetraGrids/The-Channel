...
```sh
chan system regproducer accountname1 PUB_K1_1234534... http://producer.site Antarctica
```
...
#### Using Keyd:
You can also use `keyd` instead of hard-defining keys.

```console
# config.ini:

signature-provider = KEYD:<data>   

//Example
//PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63=KEYD:https://127.0.0.1:88888
```
