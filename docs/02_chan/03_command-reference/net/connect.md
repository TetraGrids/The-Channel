...
## Command Usage
The following information shows the different positionals and options you can use with the `chan net connect` command:
...
## Examples
The following examples demonstrate how to use the `chan net connect` command:
...
```sh
chan net connect localhost:9002
```
**Output:**
```console
"added connection"
...
```sh
chan -u http://127.0.0.1:8001 net connect localhost:9002
```
**Output:**
```console
"added connection"
