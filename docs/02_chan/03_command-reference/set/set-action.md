...
```console
Usage: chan set action [OPTIONS] SUBCOMMAND
...
chan set action permission sandwichfarm ra.system voteproducer voting -p sandwichfarm@voting

#Now can execute the transaction with the previously set permissions.
chan system voteproducer approve sandwichfarm someproducer -p sandwichfarm@voting
```
