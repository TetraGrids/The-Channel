...
## Examples
Simply output the hash of ra.token contract 

```sh
chan get code ra.token
```
```console
...
```sh
chan get code ra.token -a ra.token.abi
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
...
Retrieve and save wast code for ra.token contract

```sh
chan get code ra.token -c ra.token.wast
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
saving wast to ra.token.wast
```
