...
This how-to guide provides instructions on how to create a new Antelope blockchain account using the `chan` CLI tool. You can use accounts to deploy smart contracts and perform other related blockchain operations. Create one or multiple accounts as part of your development environment setup.

The example in this how-to guide creates a new account named **bob**, authorized by the default system account **eosio**, using the `chan` CLI tool.
...
* [`chan create account`](../03_command-reference/create/account.md) command and its parameters
...
```sh
chan create account eosio bob PUB_K1_87TQktA5RVse2EguhztfQVEh6XXxBmgkU8b4Y5YnGvtY8hjMXC
```
**Where**:
...
#         eosio <= eosio::newaccount            {"creator":"ra","name":"bob","owner":{"threshold":1,"keys":[{"key":"PUB_K1_87TQktA5RVse2EguhztfQVEh6X...
