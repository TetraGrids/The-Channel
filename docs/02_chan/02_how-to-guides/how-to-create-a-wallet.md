...
Create a wallet using `keyd`.

## Before you begin

Make sure you meet the following requirements:

* Familiarize with the [`chan wallet create`](../03_command-reference/wallet/create.md) command and its parameters.
* Familiarize with the other [`chan wallet`](../03_command-reference/wallet/index.md) commands.
...
```sh
chan wallet create [-n named_wallet] -f <file_to_save_pwd>
```
...
```sh
chan wallet create -f default_wallet.pwd
```
```console
...
```sh
chan wallet create -n my_wallet -f my_wallet.pwd
```
```console
