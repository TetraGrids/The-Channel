...
* [`chan get transaction`](../03_command-reference/get/transaction.md) command and its parameters
...
```sh
chan get transaction 870a6b6e3882061ff0f64016e1eedfdd9439e2499bf978c3fb29fcedadada9b1
```
* Where `870a6b6e38...dada9b1`= The transaction ID associated with the creation of account **bob**.

**Example Output**

The `chan` command returns detailed information of the transaction:
...
[[info]]
| Be aware that you need to connect to a `channeld` instance that enables both the [history plugin](../../01_channeld/03_plugins/history_plugin/index.md) and [history API plugin](../../01_channeld/03_plugins/history_api_plugin/index.md) to query transaction information.
...
If the [history plugin](../../01_channeld/03_plugins/history_plugin/index.md) and [history API plugin](../../01_channeld/03_plugins/history_api_plugin/index.md) are not enabled in the `channeld` **config.ini file**, the `chan get transaction id` command will result in an error as shown below:

```sh
chan get transaction 509eee3aa8988d533a336fec7a4c8b067ae3205cd97e2d27b3e9a2da61ef460c
```
```console
...
To troubleshoot this error, enable the [history plugin](../../01_channeld/03_plugins/history_plugin/index.md) and [history API plugin](../../01_channeld/03_plugins/history_api_plugin/index.md), then run the command again.
