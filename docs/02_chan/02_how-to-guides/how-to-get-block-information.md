...
* Familiarize with the [`chan get block`](../03_command-reference/get/block.md) command and its parameters.
...
```sh
chan get block <block_number_or_id>
```
...
```sh
chan -u https://choiceofyourprovider get block 48351112
```
...
```sh
chan -u https://choiceofyourprovider get block 02e1c7888a92206573ae38d00e09366c7ba7bc54cd8b7996506f7d2a619c43ba
```
```json
{
  "timestamp": "2021-01-28T17:58:59.500",
